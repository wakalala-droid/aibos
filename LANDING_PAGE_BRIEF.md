...
## 11b. Asset prompt pack (for a diffusion / image-to-video model)
Engine objects are now AI-generated by the owner (the placeholder SVGs in
`public/marketing/engines/` may be replaced). Generate stills first, then animate via
image-to-video (Runway Gen-3 / Kling / Luma / Pika / Sora). **Pro tip:** render the glass
engine cores on a **pure-black background** and composite them on the dark band with CSS
`mix-blend-mode: screen` — instant transparency for glows, no alpha video needed.

**MASTER STYLE (prepend / use as style ref for consistency):**
> premium product render, translucent obsidian-glass + iridescent light refraction, volumetric inner glow, octane/redshift, ultra-detailed, soft studio rim light, deep navy void, calm high-end tech aesthetic, no text, no logos

**ENGINE CORE — still (swap [ACCENT] + [MOTIF] per engine):**
> A single translucent glass "intelligence core" floating in dark empty space — a rounded cubic crystal with frosted bevelled edges and an iridescent cyan-to-magenta rim, a glowing [ACCENT] energy core suspended inside emitting volumetric light, delicate internal data filaments forming [MOTIF], polished glass with caustics and subtle bloom, 3/4 angle, centered, pure black background. 1:1, ultra detailed.
> - Financial / AI CFO → [ACCENT]=electric cyan · [MOTIF]=a Kwacha symbol + bar-chart filaments
> - Customer → [ACCENT]=warm amber-orange · [MOTIF]=an orbiting constellation of person-nodes
> - Operations → [ACCENT]=emerald green · [MOTIF]=interlocking gears + a box lattice
> - Forecasting → [ACCENT]=violet · [MOTIF]=an upward light-trail curve arcing through the core
> - Decision → [ACCENT]=electric blue · [MOTIF]=a compass with converging rays

**ENGINE CORE — animation (image-to-video, seamless loop):**
> Seamless 8-second loop, camera locked: the glass core slowly rotates and gently levitates (soft bob), the inner energy core pulses rhythmically, light caustics drift across the surface, faint data particles orbit it, subtle lens bloom. Smooth ease-in-out, perfectly loopable, pure black background.

**HERO SCENE — still:**
> Painterly digital illustration, warm golden-hour light, soft brush texture, Studio-Ghibli-meets-editorial-tech, optimistic calm mood. A thriving Lusaka high-street at dusk — a small shop and open-air restaurant with warm interior light, a confident African shop-owner in the doorway looking forward, faint soft-cyan "data-light" particles drifting upward from the businesses (suggesting intelligence), warm sky, atmospheric depth, generous negative space on the left for a headline. 16:9, high detail, no text.

**HERO SCENE — animation (cinemagraph, ~10s loop):**
> Subtle cinemagraph: ~90% of the frame stays painterly and still; only the light animates — soft cyan data-light particles drift slowly upward, warm golden light gently shifts, faint dust/steam in the air, distant figures move slightly, clouds drift. No camera movement (or an extremely slow push-in). Calm, hopeful, seamless 10-second loop.

**INDUSTRY SCENES (same style/seed):** warm African restaurant kitchen pass at dusk · tidy retail shop, owner on phone · boutique lodge reception, golden hour · open-pit mine at sunrise, hopeful warm light. Each with the faint cyan data-light motif.

**NEGATIVE (all):** `text, words, watermark, logo, ui, deformed hands, extra fingers, harsh neon, cluttered, low-res, oversaturated`

**SETTINGS:** stills 16:9 hero/footer, 1:1 engine cores, 3:2 industry; lock ONE seed +
style reference across the set for cohesion; export 2× WebP (stills) and looping MP4/WebM
(animations) into `public/marketing/`. Respect `prefers-reduced-motion` with a still frame.
