  ...
  return (
    ...
    >
      <div style={{ flex: 1, minWidth: 200 }}>
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.88rem', fontWeight: 700, color: 'var(--text-1)', margin: '0 0 2px' }}>
          {active.headline}
        </p>
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.78rem', color: 'var(--text-3)', margin: 0, lineHeight: 1.45 }}>
          {active.detail}
        </p>
      </div>
