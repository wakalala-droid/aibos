    ...
    <svg viewBox="0 0 800 520" role="img" aria-label="Painterly scene: an open-pit mine in Kitwe before dawn — a tipper truck descends the haul road with headlights on, a lone lit window in the site office, and Chanda stands on the rim under a fading starfield.">
      <defs>
        <linearGradient id="s1sky" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="0.78" stopColor="#553055" />
          <stop offset="1" stopColor="#c25b2e" />
        </linearGradient>
        <radialGradient id="s1amber" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#ffb56b" stopOpacity="0.55" />
      ...
      <g filter="url(#s1p)">
        <path d="M0,336 C160,328 400,340 620,330 C700,326 760,330 800,326 L800,368 C600,376 240,380 0,372 Z" fill="#10142f" />
        <path d="M30,372 C260,382 540,378 800,366 L800,410 C560,420 260,422 60,412 Z" fill="#0d1129" />
        <path d="M90,412 C300,422 560,418 770,406 L750,450 C540,458 300,460 130,450 Z" fill="#0a0e24" />
        <ellipse cx="430" cy="470" rx="270" ry="30" fill="#080b1e" />
        {/* haul road sweeping down from the right rim */}
        <path d="M800,356 C700,372 620,400 560,436 C540,448 520,458 505,462 L545,468 C580,452 650,412 730,384 C762,373 786,366 800,364 Z" fill="#12163a" />
      </g>
      <g fill="none" stroke="#d06f3c" strokeWidth="2" opacity="0.26" filter="url(#s1p)">
  ...
  return (
    <svg viewBox="0 0 800 520" role="img" aria-label="Painterly scene: the site office at night — Chanda hunched under a desk lamp over open exercise books and loose papers, steam rising from a cooling mug, the pit lights faint through the window.">
      ...
      <g fill="#ffc37a">
        ...
        <circle cx="150" cy="96" r="7" fill="#dfe6ff" opacity="0.5" />
      </g>

      {/* wall clock — 21:15 */}
      <g transform="translate(330,96)" filter="url(#s2p)">
        <circle r="21" fill="#1c1730" stroke="#3a2f47" strokeWidth="2" />
        <line x1="0" y1="0" x2="0" y2="-9" stroke="#cfa76a" strokeWidth="2.4" transform="rotate(278)" />
        <line x1="0" y1="0" x2="0" y2="-14" stroke="#cfa76a" strokeWidth="1.6" transform="rotate(90)" />
      </g>
...
export function SceneUpload() {
  return (
    <svg viewBox="0 0 800 520" role="img" aria-label="Painterly scene: Chanda at his kitchen table on a Sunday evening — a laptop showing a small glowing chart lights his face while soft cyan data-light drifts up from the screen; a violet-and-amber dusk stands in the window behind him.">
      ...
      <ellipse cx="150" cy="120" rx="120" ry="90" fill="url(#s3lamp)" />
  ...
  return (
    <svg viewBox="0 0 800 520" role="img" aria-label="Painterly scene: the open pit at golden hour — terraces glowing amber under a low sun, a loaded tipper climbing the haul road, cyan data-light rising over the weighbridge office, and Chanda walking home in warm light.">
      ...
      <g filter="url(#s4p)">
        ...
        <ellipse cx="430" cy="458" rx="270" ry="30" fill="#5c3423" />
      ...
      {/* conveyor + stockpile on the right rim */}
      <g filter="url(#s4p)">
        <path d="M690,318 L754,318 L722,278 Z" fill="#6e402a" />
        <line x1="500" y1="420" x2="716" y2="298" stroke="#402818" strokeWidth="5" />
        <line x1="560" y1="386" x2="560" y2="416" stroke="#402818" strokeWidth="3" />
        <line x1="626" y1="349" x2="626" y2="392" stroke="#402818" strokeWidth="3" />
        <line x1="684" y1="316" x2="684" y2="360" stroke="#402818" strokeWidth="3" />
      </g>
      ...
      <g transform="translate(104,318)">
        ...
        <g fill="#2fd0f0">
          <circle className="sc-data" cx="12" cy="-38" r="2" />
          <circle className="sc-data" cx="26" cy="-46" r="1.6" style={{ animationDelay: '1.8s' }} />
          <circle className="sc-data" cx="38" cy="-34" r="2.2" style={{ animationDelay: '3.6s' }} />
          <circle className="sc-data" cx="20" cy="-28" r="1.5" style={{ animationDelay: '5.6s' }} />
          <circle className="sc-data" cx="32" cy="-56" r="1.4" style={{ animationDelay: '7.2s' }} />
        </g>
      </g>
