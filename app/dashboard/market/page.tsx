    ...
    <>
                ...
                <motion.tr key={s.segment} initial={{ opacity: 0, x: -6 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 + i * 0.05 }}>
                  <td>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <span style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600, color: 'var(--text-1)' }}>{s.segment}</span>
                    </div>
                  </td>
      ...
      <SectionCard title="AI Market Intelligence Brief" subtitle="Customer Intelligence · llama-3.3-70b · Kwacha analysis" delay={0.24} style={{ position: 'relative' }}>
        ...
        {briefLines.length > 0 ? (
          ...
          <p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.72rem', color: 'var(--text-4)', textAlign: 'center', padding: '20px 0' }}>Upload transaction data to generate AI market intelligence</p>
        )}
