  ...
  return (
    <div style={{ paddingBottom: last ? 0 : 18, marginBottom: last ? 0 : 18, borderBottom: last ? 'none' : '1px solid var(--border)' }}>
      ...
      <p style={{ ...BODY, marginBottom: 16 }}>
        ...
        you confirm the booking or turn it down. If money is still owed, they get a reminder 3 days
        before they arrive, with a link to pay. When they reply, it comes to you.
      </p>
