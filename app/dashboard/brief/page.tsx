      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 20 }}>
        ...
        <Card delay={0.08}>
          ...
          <BriefSection icon={<span style={{fontSize:'11px'}}>🔮</span>} title="Forward Outlook" delay={0.3}>
            <Insight colour="#a78bfa" text={`Base case: Q1 next year revenue of ${formatCurrency(forecast[0]?.forecast ?? 281000, true, sym)}, growing to ${formatCurrency(forecast[2]?.forecast ?? 314000, true, sym)} by Q1 end. Full-year implied revenue: $3.2M–$3.6M.`}/>
